...
class GuardiansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guardian" do
    assert_difference("Guardian.count") do
      post guardians_url, params: { guardian: { contact_number: @guardian.contact_number, email_address: @guardian.email_address, name: @guardian.name, number_of_students: @guardian.number_of_students, student_id: @guardian.student_id } }
    end
  ...
  test "should update guardian" do
    patch guardian_url(@guardian), params: { guardian: { contact_number: @guardian.contact_number, email_address: @guardian.email_address, name: @guardian.name, number_of_students: @guardian.number_of_students, student_id: @guardian.student_id } }
